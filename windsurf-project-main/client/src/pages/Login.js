      ...
      <div className="relative max-w-md w-full space-y-8 z-10">
        ...
        <div className="text-center animate-fadeInUp">
          ...
          <p className="text-xl text-white/90 max-w-sm mx-auto">
            Sign in to your JobPortal account and continue your journey
          </p>
        </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center py-3 px-4 border border-transparent text-sm font-bold rounded-xl text-white bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 transition-all duration-300 transform hover:scale-105 shadow-lg btn-glow"
              >
                {loading ? (
            ...
            {/* <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full inline-flex justify-center py-2 px-4 border-2 border-gray-300 rounded-xl shadow-sm bg-white/80 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all duration-300 transform hover:scale-105"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12.24 10.285V14.4h6.806c-.275 1.765-2.056 5.174-6.806 5.174-4.095 0-7.439-3.389-7.439-7.574s3.345-7.574 7.439-7.574c2.33 0 3.89.82 5.155 2.095l3.145-3.145C19.305 1.24 16.17 0 12.24 0 7.515 0 2.73 4.01 2.73 9c0 4.99 4.785 9 9.51 9 5.73 0 9.51-4.01 9.51-9 0-.6-.067-1.2-.174-1.715H12.24z"/>
                </svg>
        ...
        <div className="text-center animate-fadeInUp" style={{ animationDelay: '200ms' }}>
          <p className="text-white/90 text-lg">
            ...
            <Link to="/register" className="font-bold text-white hover:text-cyan-300 transition-colors duration-300 underline decoration-2">
              Sign up for free
            </Link>
          </p>
        </div>
